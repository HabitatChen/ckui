...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: 'ck-upload-list' }, fileList.map(function (item) {
        return React.createElement("li", { className: 'ck-upload-list-item', key: item.uid },
